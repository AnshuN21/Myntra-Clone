            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to={'/'} className='flex'>
                  <div className="flex ">
                    <img 
            className="myntra_home w-[8%]"
            src="images/myntra_logo.webp"
            alt="Myntra Home"
          />
                    <h1 className=' text-4xl font-bold text-[#f20390] px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}>Myntra</h1>
                  </div>
                </Link>
              </div>
                ...
                <div className="hidden lg:ml-8 lg:flex">
                  <a href="#" className="flex items-center text-gray-700 ">
                    <img
                      ...
                      // src='https://m.media-amazon.com/images/I/61IrIgy84QL._SX679_.jpg'
                      src='https://images.pexels.com/photos/19149254/pexels-photo-19149254/free-photo-of-hand-with-cup-of-coffee-by-small-christmas-tree.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load'
                      alt="Anshu" />
                  </a>
                </div>
